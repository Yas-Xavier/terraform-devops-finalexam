    ...
    stages {
        ...
        stage('Deploy to Testing') {
            steps {
                ...
                script {
                    sh '''
                    ssh -i /home/cloudshell-user/terraform-devops-finalexam/controller_agent_key ec2-user@$TESTING_SERVER '
        ...
        stage('Deploy to Staging') {
            ...
            steps {
                ...
                script {
                    sh '''
                    ssh -i /home/cloudshell-user/terraform-devops-finalexam/controller_agent_key ec2-user@$STAGING_SERVER '
                        sudo rm -rf /var/www/html/*
                        sudo dnf update -y
                        sudo dnf install -y git httpd
                        sudo systemctl enable httpd
            ...
            steps {
                ...
                script {
                    ...
                    for (server in servers) {
                        sh """
                        ssh -i /home/cloudshell-user/terraform-devops-finalexam/controller_agent_key ec2-user@${server} '
                            sudo rm -rf /var/www/html/*
                            sudo dnf update -y
                            sudo dnf install -y git httpd
                            sudo systemctl enable httpd
